...
describe("Components: FavoriteDogs", () => {
  it("should render button", () => {
    render(<FavoriteDogs selectedDogs={selectedDogs} onRemove={mockRemove} onReset={mockReset} />);
  ...
  it("renders dialog content", async () => {
    ...
    expect(screen.getByRole("button", { name: "Find my match!" })).toBeVisible();
  ...
  it("calls onRemove", async () => {
    render(<FavoriteDogs selectedDogs={selectedDogs} onReset={mockReset} onRemove={mockRemove} />);
  ...
  it("calls getMatch and routes to /match", async () => {
    ...
    await userEvent.click(screen.getByRole("button"));
    await userEvent.click(screen.getByRole("button", { name: "Find my match!" }));
