...
describe("Components: Result", () => {
  ...
  it("should render expected result", () => {
    render(
      <Result choice={HandType.LIZARD} houseChoice={HandType.SPOCK} result={ResultType.WIN} />,
    );
  ...
  it("should render tie", () => {
    render(
      <Result choice={HandType.LIZARD} houseChoice={HandType.LIZARD} result={ResultType.TIE} />,
    );
