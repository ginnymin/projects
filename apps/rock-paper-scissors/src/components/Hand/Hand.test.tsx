...
describe("Components: Hand", () => {
  ...
  it("should render large size", () => {
    ...
    expect(screen.getByRole("button", { name: HandType.LIZARD })).toHaveClass("scale-[0.45] -m-20");
  });

  it("should render default size", () => {
    render(<Hand type={HandType.LIZARD} size="default" />);

    expect(screen.getByRole("button", { name: HandType.LIZARD })).toHaveClass("scale-[0.48] -m-16");
  });
});
