...
export const Button: FC<Props> = ({ size = "medium", children, className, ...props }) => {
  const classes = clsx(
    ...
    {
      "rounded-md px-10 py-1.5 shadow-[0px_0px_6px_1px_rgba(0,0,0,0.2)] ": size === "large",
    },
    {
      "rounded-sm text-sm px-5 py-1.5 shadow-[0px_0px_4px_0px_rgba(0,0,0,0.2)] ": size === "medium",
    },
    className,
  );
