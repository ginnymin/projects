...
describe("Components: RegionSelector", () => {
  it("renders", () => {
    ...
    expect(screen.getByRole("button", { name: "Filter by Region" })).toBeVisible();
  ...
  it("renders options", async () => {
    ...
    expect(within(listbox).getByRole("option", { name: "Americas" })).toBeVisible();
    expect(within(listbox).getByRole("option", { name: "Europe" })).toBeVisible();
    expect(within(listbox).getByRole("option", { name: "Asia" })).toBeVisible();
    expect(within(listbox).getByRole("option", { name: "Africa" })).toBeVisible();
    expect(within(listbox).getByRole("option", { name: "All regions" })).toBeVisible();
  });
  ...
  it("renders selected option", async () => {
    ...
    expect(within(listbox).getByRole("option", { name: "Europe", selected: true })).toBeVisible();
  });
