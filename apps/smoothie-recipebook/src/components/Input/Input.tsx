  ...
  return (
    <div className={clsx("flex flex-col", className)}>
      ...
      <div className="relative w-full">
        {leading && <HiOutlineSearch className="size-5 absolute left-3 top-[calc(50%-10px)]" />}
        <input
          {...props}
          aria-label={hideLabel ? label : undefined}
          id={id}
          className={clsx("rounded-md bg-neutral-100 w-full px-3 py-2 disabled:bg-gray-100", {
